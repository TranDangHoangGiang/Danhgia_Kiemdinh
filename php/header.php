...
<header>
        <div class="navbar">
            <div class="nav-logo">
                <div class="logo">
                    <a href="index1.php"><img src="./img/logosale.jpg" alt=""></a>
                </div>
            </div>
            ...
            <div class="nav-signin">
                <p><span>Xin chào <br> <?php echo $user['name'] ?></span></p>
            </div>
            <?php }?>
            ...
            <div class="nav-card">
                ...
                <a href="cart.php"><p class="nav-second">Giỏ hàng</p></a>
            </div>
            ...
            <div class="panel-dropdown">
                <div class="panel-dropdown-menu">
                    <ul>
                        <li><a href="index1.php"><i class="fa-solid fa-house"></i>Trang chủ</a></li>
                        <li><a href="category.php"><i class="fa-solid fa-couch"></i>Gia dụng phòng khách</a>
                            <ul id="submenu">
                                <li><a href="">Bàn, ghế</a></li>
                                <li><a href="">Kệ tủ</a></li>
                                <li><a href="">Đồ trang trí</a></li>
                                <li><a href="">Đồ gia dụng khác</a></li>
                            </ul>
                        </li>
                        <li><a href="category.php"><i class="fa-solid fa-kitchen-set"></i>Gia dụng phòng bếp</a>
                            <ul id="submenu">
                                <li><a href="">Bàn, ghế</a></li>
                        ...
                        <li><a href="category.php"><i class="fa-solid fa-shower"></i>Gia dụng phòng tắm</a>
                            <ul id="submenu">
                                <li><a href="">Bồn tắm, Bồn rửa mặt</a></li>
                                <li><a href="">Toilet</a></li>
                                <li><a href="">Gương tắm</a></li>
                                <li><a href="">Đồ gia dụng khác</a></li>
                            </ul>
                        </li>
                        <li><a href="category.php"><i class="fa-solid fa-bed"></i>Gia dụng phòng ngủ</a>
                            <ul id="submenu">
                        ...
                        <li><a href=""><i class="fa-solid fa-comment"></i>Tin tức</a></li>
                        <li><a href=""><i class="fa-solid fa-blog"></i>Blog kiến thức</a></li>
